...
//	pProbImg = cvCreateImage( cvGetSize(pImg), 8, 1 );
	pHSVImg  = cvCreateImage( cvSize(640,480), 8, 3 );
	pHueImg  = cvCreateImage( cvSize(640,480), 8, 1 );
	pMask    = cvCreateImage( cvSize(640,480), 8, 1 );
	pProbImg = cvCreateImage( cvSize(640,480), 8, 1 );
